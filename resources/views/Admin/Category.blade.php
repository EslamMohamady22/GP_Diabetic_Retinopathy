                    ...
                    <div class="row">
                                ...
                                <div class="form-group">
                                    <label for="exampleFormControlTextarea1">اسم القسم
                                        :</label>
                                    <input class="form-control" type="text" name="name" id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;"
                                        rows="3" required>
                                </div>
            <div class="modal-footer">
                <button type="button" class="btn btn-secondary"
