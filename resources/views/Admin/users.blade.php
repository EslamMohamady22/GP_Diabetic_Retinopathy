                                        ...
                                        <form action="{{ route('users.update', 'test') }}" method="post">
                                            ...
                                            <div class="form-group">
                                                <label
                                                    ...
                                                    :</label>
                                                    <select name="gender"
                                                     required id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;" class="form-select" aria-label="Default select example">
                                            ...
                                            <div class="form-group">
                                                <label
                                                    ...
                                                    id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;" required>
                ...
                <form action="{{ route('users.store') }}" method="POST">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">العنوان
                            :</label>
                        <input class="form-control" type="text" name="address" id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;"
                            rows="3" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">السن
                            :</label>
                        <input class="form-control"type="number" name="age" id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;"
                            rows="3" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">التخصص
                            :</label>
                        <input class="form-control" type="text" name="speciality" id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;"
                            rows="3">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">النوع
                            :</label>
                            <select name="gender"
                            id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;" class="form-select" aria-label="Default select example" required>
                              <option value="ذكر">ذكر</option>
                              <option value="انثي">انثي</option>
                            </select>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">رقم الهاتف المحمول
                            :</label>
                        <input class="form-control" name="phonenumber" id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;"
                            rows="3" type="number" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">رقم البطاقة
                            :</label>
                        <input class="form-control" type="number" name="socialid" id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;"
                            rows="3" required>
                    </div>
                    <div class="form-group">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1"> الشهادة
                            :</label>
                        <input class="form-control" type="text" name="certifcate" id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;"
                            rows="3">
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">البريد الالكتروني
                            :</label>
                        <input class="form-control" name="email" id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;"
                            rows="3" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">الرقم السري
                            :</label>
                        <input type="password" class="form-control" name="password" id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;"
                            rows="3" required>
                    </div>
                    <br><br>
            </div>
