...
<div class="col-xl-12 mb-30">
    <div class="card card-statistics h-100">
        ...
        @endif
            ...
            <form method="post" action="{{ route('fees.bulk_delete') }}" style="display: inline-block;">
                @csrf
                @method('delete')
            ...
            <div class="table-responsive">
                <table id="datatable" class="table  table-hover table-sm table-bordered p-0" data-page-length="50"
                    ...
                    <tbody>
                        @foreach ($fees as $fee)
                        <tr id="sid{{ $fee->id}}">
                            <td><input type="checkbox" name="ids[{{ $fee->id }}]" class="checkbox" value="{{ $fee->id }}"/></td>
                                <td>{{ $fee->name }}</td>
                                <td>{{ $fee->socialid }}</td>
                ...
                <form action="{{ route('fees.store') }}" method="POST" enctype="multipart/form-data">
                    ...
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">رقم البطاقة
                            :</label>
                        <input class="form-control" type="text" value="{{$user->socialid}}" name="socialid" id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;"
                            rows="3" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">رقم الفاتورة
                            :</label>
                        <input class="form-control" type="text" name="invoice_number" id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;"
                            rows="3" required>
                    </div>
                    <div class="form-group">
                        <label for="exampleFormControlTextarea1">نوع الفاتورة
                    ...
                    <div class="form-group">
                        ...
                        <input class="amount" type="text" name="others" id="exampleFormControlTextarea1" placeholder="بحث..." style="border: 1px solid #e3e3e3;padding: 1rem;border-radius: 20px;font-size: 18px;"
